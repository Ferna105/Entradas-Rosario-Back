#!/usr/bin/env bash
# Ejecuta docker/migration_favorites.sql contra la base indicada.
#
# Uso (elige una):
#   1) URL de conexión:
#        export DATABASE_URL="postgresql://user:pass@host:5432/dbname"
#        ./scripts/run-favorites-migration.sh
#
...
#        ./scripts/run-favorites-migration.sh /ruta/al/.env.production
#
...
MIGRATION="$BACKEND_ROOT/docker/migration_favorites.sql"
